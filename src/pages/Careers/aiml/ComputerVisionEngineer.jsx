...
const ComputerVisionEngineer = () => {
  const [showShareMenu, setShowShareMenu] = useState(false);
  const [copied, setCopied] = useState(false);

  const jobDetails = {
    title: "Computer Vision Engineer at Ivish AI",
    description: "Join our innovative team as a Computer Vision Engineer. Remote position with competitive salary.",
    url: window.location.href,
  };

  const responsibilities = [
    "Develop and implement computer vision algorithms and models",
    "Conduct research to improve image and video processing techniques",
    "Collaborate with data scientists and engineers to deploy CV solutions",
  ...
  const requirements = [
    ...
    "Experience with Python and relevant libraries (OpenCV, TensorFlow)",
  ...
  const benefits = [
    ...
    { icon: Camera, text: "Learning & development budget" },
    { icon: CheckCircle, text: "Flexible working hours" }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <Camera size={32} />
              <h1 className="text-4xl md:text-5xl font-bold">Computer Vision Engineer</h1>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                We're seeking a skilled Computer Vision Engineer to join our team at Ivish AI. 
                You'll be responsible for developing and implementing computer vision algorithms and models.
              </p>
            </section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "OpenCV", "TensorFlow", "Keras"].map((tech, index) => (
                  <span
                    key={index}
...
export default ComputerVisionEngineer;
