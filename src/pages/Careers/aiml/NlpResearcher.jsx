...
const NlpResearcher = () => {
  ...
  const jobDetails = {
    title: "NLP Researcher at Ivish AI",
    description: "Join our innovative team as an NLP Researcher. Remote position with competitive salary.",
    url: window.location.href,
  };

  const responsibilities = [
    "Develop and implement NLP algorithms and models",
    "Conduct research to improve natural language understanding",
    "Collaborate with data scientists and engineers to deploy NLP solutions",
  ...
  const requirements = [
    ...
    "Experience with Python and relevant libraries (NLTK, SpaCy)",
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <Brain size={32} />
              <h1 className="text-4xl md:text-5xl font-bold">NLP Researcher</h1>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                We're seeking a skilled NLP Researcher to join our team at Ivish AI. 
                You'll be responsible for developing and implementing NLP algorithms and models.
              </p>
            </section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "NLTK", "SpaCy", "TensorFlow"].map((tech, index) => (
                  <span
                    key={index}
