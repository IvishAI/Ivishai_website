...
const FrontendDeveloper = () => { 
  ...
  const jobDetails = {
    title: "Frontend Developer at Ivish AI",
    description: "Join our innovative team as a Frontend Developer. Remote position with competitive salary.",
    url: window.location.href,
  };

  const responsibilities = [
    "Design and implement user interfaces using React and Next.js",
    "Collaborate with designers to transform mockups into responsive layouts",
  ...
  const requirements = [
    ...
    "Strong proficiency in TypeScript and state management (Redux/Context)",
    "Experience with Next.js and server-side rendering",
    "Expertise in modern CSS, Tailwind CSS, and responsive design",
  ...
  const benefits = [
    ...
    { icon: Laptop, text: "Remote-first culture" },
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              <Code size={32} />
              <h1 className="text-4xl md:text-5xl font-bold">Frontend Developer</h1>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                We're looking for a passionate Frontend Developer to join our innovative team at Ivish AI. 
                You'll be working on cutting-edge AI-powered applications, creating intuitive user interfaces 
                that make complex technologies accessible to everyone.
              </p>
            </section>
