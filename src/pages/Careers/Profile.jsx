...
import {
  LogOut, Edit, Save, Briefcase, FileText,
  User, Trash2, Mail, Github, Linkedin,
  Globe, GraduationCap, Phone,
  FileUp, Link, Camera
} from "lucide-react";
        ...
        <div className="p-6">
          ...
          <ul className="space-y-2">
            {[
              ...
              <li
                key={name}
                className={`flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer transition-all ${selectedTab === name
