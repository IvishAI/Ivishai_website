...
const navLinks = [
  { label: "Overview", to: "/retail-os", short: "Overview" },
  { label: "Features", to: "/retail-os/features", short: "Features" },
  { label: "Industries", to: "/retail-os/industries", short: "Industries" },
  { label: "Pricing", to: "/retail-os/pricing", short: "Pricing" },
];
